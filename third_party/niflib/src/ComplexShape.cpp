...
#include "nif/gen/BodyPartList.h"
...
Ref<NiAVObject> ComplexShape::Split( NiNode * parent, Matrix44 & transform, int max_bones_per_partition, bool stripify, bool tangent_space, float min_vertex_weight, ubyte_t tspace_flags ) const {
