...
ATextureRenderData::ATextureRenderData() : pixelFormat((PixelFormat)0), redMask((unsigned int)0), greenMask((unsigned int)0), blueMask((unsigned int)0), alphaMask((unsigned int)0), bitsPerPixel((ubyte_t)0), unknownInt((unsigned int)0), unknownInt2((int)0), unknownInt3((unsigned int)0), flags((ubyte_t)0), unknownInt4((unsigned int)0), unknownByte1((ubyte_t)0), palette(NULL), numMipmaps((unsigned int)0), bytesPerPixel((unsigned int)0) {
