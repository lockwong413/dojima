...
NiParticleSystemController::NiParticleSystemController() : oldSpeed((unsigned int)0), speed(0.0f), speedRandom(0.0f), verticalDirection(0.0f), verticalAngle(0.0f), horizontalDirection(0.0f), horizontalAngle(0.0f), size(0.0f), emitStartTime(0.0f), emitStopTime(0.0f), unknownByte((ubyte_t)0), oldEmitRate((unsigned int)0), emitRate(0.0f), lifetime(0.0f), lifetimeRandom(0.0f), emitFlags((unsigned short)0), emitter(NULL), unknownShort2_((unsigned short)0), unknownFloat13_(0.0f), unknownInt1_((unsigned int)0), unknownInt2_((unsigned int)0), unknownShort3_((unsigned short)0), particleLifetime(0.0f), particleLink(NULL), particleTimestamp((unsigned int)0), particleUnknownShort((unsigned short)0), particleVertexId((unsigned short)0), numParticles((unsigned short)0), numValid((unsigned short)0), unknownLink(NULL), particleExtra(NULL), unknownLink2(NULL), trailer((ubyte_t)0), colorData(NULL), unknownFloat1(0.0f) {
