...
NiObjectNET::NiObjectNET() : skyrimShaderType((BSLightingShaderPropertyShaderType)0), hasOldExtraData(false), oldExtraInternalId((unsigned int)0), unknownByte((ubyte_t)0), extraData(NULL), numExtraDataList((unsigned int)0), controller(NULL) {
