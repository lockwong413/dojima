...
bhkConvexListShape::bhkConvexListShape() : numSubShapes((unsigned int)0), material((HavokMaterial)0), skyrimMaterial((SkyrimHavokMaterial)0), unknownFloats(6,(float)0.0,(float)0.0,(float)-0.0,(float)0.0,(float)0.0,(float)-0.0), unknownByte1((ubyte_t)0), unknownFloat1(0.0f) {
