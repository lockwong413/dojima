...
NiAVObject::NiAVObject() : flags((unsigned short)0), unknownShort1((unsigned short)8), scale(1.0f), numProperties((unsigned int)0), unknown2((ubyte_t)0), hasBoundingBox(false), collisionObject(NULL) {
