...
#include "nif/gen/OblivionSubShape.h"
using namespace Niflib;

//Constructor
OblivionSubShape::OblivionSubShape() : layer((OblivionLayer)0), colFilter((ubyte_t)0), unknownShort((unsigned short)0), numVertices((unsigned int)0), material((HavokMaterial)0) {};
