...
//Constructor
FurniturePosition::FurniturePosition() : orientation((unsigned short)0), positionRef1((ubyte_t)0), positionRef2((ubyte_t)0), heading(0.0f), animationType((AnimationType)0), entryProperties((FurnitureEntryPoints)0) {};
