...
#include "nif/gen/MeshData.h"
#include "nif/Ref.h"
#include "nif/gen/ExtraMeshDataEpicMickey.h"
#include "nif/gen/ExtraMeshDataEpicMickey2.h"
namespace Niflib {
...
public:
	...
	NIFLIB_API MeshPrimitiveType GetPrimitiveType() const {
		return primitiveType;
	}

	NIFLIB_API unsigned short GetNumSubmeshes() const {
		return numSubmeshes;
	}
	
	NIFLIB_API unsigned int GetNumMeshData() const {
		return numDatas;
	}

	NIFLIB_API const vector<MeshData> & GetMeshDatas() const {
		return datas;
	}
